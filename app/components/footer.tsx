      ...
      <section className="flex flex-col gap-8 w-full">
        ...
        <div className="flex flex-col gap-8 max-w-[500px]">
          ...
          <div className="flex flex-col gap-4">
            <input type="text" className="border-b-1 border-[#2d2df1] p-2" placeholder="Enter Your Email Address" />
            <button className="px-4 py-2 border-1 border-[#2d2df1] rounded-full text-[#2d2df1]">Subscribe</button>
          </div>
        </div>
